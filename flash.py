...
def file_crc32_mpeg2(data_bytes, poly=0x04C11DB7, init=0xFFFFFFFF, log_file="crc_log.txt"):
    crc = init
...
def run_bootloader():
    ...
    try:
        ser = serial.Serial('COM7', 9600) # Added timeout for safety
    ...
    golden_crc = file_crc32_mpeg2(payload)
